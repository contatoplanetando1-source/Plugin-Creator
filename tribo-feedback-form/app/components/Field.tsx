...
export default function Field({
  ...
  return (
    <div className="border-b border-v4-gray-light py-7 first:pt-0 last:border-b-0 last:pb-0">
      <div className="mb-4 flex gap-3">
        <span className="mt-0.5 flex h-6 w-6 flex-none items-center justify-center rounded-full bg-v4-near-black text-xs font-bold text-white">
          {number}
        </span>
        <div>
